"""
匯出 DDRNet-23-slim (BCEDice v0) checkpoint 為 TorchScript 模型
...
執行方式：
  ...
  python export_ddrnet_v0_torchscript.py
"""
...
# ── 路徑設定 ─────────────────────────────────────────────
CFG_PATH = Path(r"H:\ChihleeMaster\dev\ABECIS_MODEL_SWAP\configs\final\ddrnet.yaml")

CKPT_PATH = Path(
    r"H:\ChihleeMaster\dev\ABECIS_MODEL_SWAP\outputs\checkpoints\ddrnet\best.pth"
)
