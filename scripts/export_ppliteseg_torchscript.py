"""
匯出 PP-LiteSeg-T checkpoint 為 TorchScript 模型
...
執行方式：
  ...
  python export_ppliteseg_torchscript.py
"""
...
# ── 路徑設定 ─────────────────────────────────────────────
CFG_PATH = Path(r"H:\ChihleeMaster\dev\ABECIS_MODEL_SWAP\configs\final\ppliteseg.yaml")

CKPT_PATH = Path(
    r"H:\ChihleeMaster\dev\ABECIS_MODEL_SWAP\outputs\checkpoints\ppliteseg\best.pth"
)
